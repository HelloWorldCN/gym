...
def log_to_linear(value):
    ...
    value = np.clip(value.cpu().numpy(), 0, 1)
...
class GymEnv:
    ...
    def step(self, action):
        ...
        """
            如果要结合更多的webrtc内核信息，那就必须返回更多的历史信息，不仅仅是packet基本信息
            还需要结合编码信息，当前计算能力，能量消耗，画面质量等信息
            来重新组成新的状态记录
        """
        ...
        # calculate reward根据gym给出的当前网络记录重新计算对应的reward
